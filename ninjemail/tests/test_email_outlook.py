...
def mock_outlook(monkeypatch):
    ...
    monkeypatch.setattr('ninjemail.email_providers.outlook.handle_captcha', lambda *args, **kwargs: None)
    monkeypatch.setattr('ninjemail.email_providers.outlook.handle_post_challenge_state', lambda *args, **kwargs: "account_home")
    monkeypatch.setattr('ninjemail.email_providers.outlook.verify_account_creation', lambda *args, **kwargs: True)
